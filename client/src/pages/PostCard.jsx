...
export default function PostCard({post}) {
  return (
    <div className='group relative w-full border border-teal-500 hover:border-2 h-[400px] overflow-hidden rounded-lg sm:w-[430px] transition-all'>
        ...
        <img className='h-[240px] w-full object-cover group-hover:h-[200px] transition-all duration-300 z-20 bg-gray-500' src={post.postImg} alt="" />
        </Link>
        <div className="flex flex-col p-2 gap-2">
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-gray-900 dark:bg-gray-700 bg-opacity-75  text-center py-2 rounded-b-md opacity-100 group-hover:opacity-0 transition-opacity">
